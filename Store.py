...
class Product :
   ...
   def __int__(self,ID_code,title,description,price,quantity_available):
...
class Customer:
    ...
    def __int__(self,customer_name,account_ID,premium_status):
...
class Store:
    ...
    def __int__(self,inventory =[],members = []):
